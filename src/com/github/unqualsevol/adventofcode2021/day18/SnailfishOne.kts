...
var input = File("input").readLines().map { toTree(it) }

val sumNumber = input.reduce { acc, current -> add(acc, current) }
println("Magnitude of the final sum: ${magnitude(sumNumber)}")
